...
<br> 
Once we understand the data generation mechanism of fMRI data, and have become familiar with the parameters needed, we can proceed to simulate desired fMRI data.

<br> 
To examine the quality of the simulated data; a convenient way is to visualize it. For example, imaging there is a brain region associated with abnormal activities (such as a tumor); and we wish to simulate fMRI data in this scenario. Below is the 3-D visulization of simulated data for a slide of brain over 100 time points. Notice the region with intensive signals. 
