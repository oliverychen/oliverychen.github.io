...
Now that we understand the general mechanism of fMRI data; we need to know when does the activation starts for each experimental design, where does the activation occur in the brain, etc. We call these fMRI generating parameters. 

<br>
The parameters we need to specify prior to data generalization are:
<li>onset time;</li>
