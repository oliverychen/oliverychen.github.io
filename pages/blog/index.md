...
<br>
Readers who are interested in the estimating procedures of the above model could discuss with me <a href="mailto:olivery.chen@yahoo.com?Subject=fMRI%20code" target="_top">via email</a>. If one is interested in learning more about functional data analysis, please refer to the following wonderful resources: <a href="https://books.google.com/books?id=fgLqBwAAQBAJ&printsec=frontcover&dq=Functional+data+analysis&hl=en&sa=X&ved=0ahUKEwifw_Lc0fnNAhVClR4KHYHvDpUQ6AEINjAA#v=onepage&q=Functional%20data%20analysis&f=false">Ramsay (2006)</a> proivdes a broad overview of functional data analysis methods with applications to curve and image analysis; and <a href="https://books.google.com/books?hl=en&lr=&id=Y4uEvXFP2voC&oi=fnd&pg=PR13&dq=David+Ruppert&ots=qdQENMEmTh&sig=FNN071YRJZbfGOa1ezchjP_b5WI#v=onepage&q=David%20Ruppert&f=false">Ruppert et al. (2003)</a> overviews functional data analysis in the semiparametric framwork in detail.
