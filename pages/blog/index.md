...
">Aertsen and Preißl (1991)</a>). Nontheless, <i>effective connectivity</i> regards the effect one neuron has on another and is time dependet, whereas <i>effective</i> network strength is time-independent as when taking the connectivity matrix, the time is averaged out.
