...
<h5>III. Clustering Analysis</h5>

Clustering analysis, by definition, is to cluster observation (potentially of multiple dimensions) into groups, where the within-cluster members are more <i>similar</i> (in terms of distance, for example) than between-cluster members.
<br>
<br>
There are many types of clustering algorithms (see <a href="https://arxiv.org/pdf/1205.1117v1.pdf"> Madhulatha (2012) </a>for a review, for example). Note that, in the high-dimensional cases, many algorithms are likely to fail due to the curse of dimensionality, and <a href="https://en.wikipedia.org/wiki/Clustering_high-dimensional_data">subspace clustering, correlation clustering and projected clustering</a> are alternatively considered.
<br> 
<br>
...
<br> 
<br>
Hartigan (1975) introduced the k-means algorithm in detail. Four years later, the journal <i>Journal of the Royal Statistical Society (Series C)</i> published a number of useful and poweful statistical algorithms and included <a href="https://www.jstor.org/stable/2346830?seq=1#page_scan_tab_contents">Hartigan and Wong (1979)</a> as Algorithm 136. 
<br> 
<br>
To begin, we note that, in general, the k-means algorithm requires input of an <img center src="http://latex.codecogs.com/gif.latex?
M \times N 
" border="0"/> matrix, where M indicates M subjects and N indicates N variables. For example, in functional connectivity analysis, where, for each subject we have a connectivity matrix. Before data input, we, for instance, vectorize (the upper or lower triangular part of) the connectivity matrix into a vector of length N. Hence, we obtain the suitable input data matrix.
<br> 
<br>
The simple goal is to find a map <img center src="http://latex.codecogs.com/gif.latex?
\mathcal{A}_k
" border="0"/> so that the resulting partition <img center src="http://latex.codecogs.com/gif.latex? 
Y = \mathcal{A}_k (\bold{X})
" border="0"/>, where <img center src="http://latex.codecogs.com/gif.latex? 
Y = \{1, 2, \cdots, K}
" border="0"/> have K values. It is equivalent to say that Y corresponds to K partitions of the input data (<img center src="http://latex.codecogs.com/gif.latex? 
\{G_1, G_2, \cdots, G_k}
" border="0"/>), where <img center src="http://latex.codecogs.com/gif.latex? 
X_i 
" border="0"/> (data from the 
<img center src="http://latex.codecogs.com/gif.latex? 
i^{th}
" border="0"/> 
subject) belongs to one of the <img center src="http://latex.codecogs.com/gif.latex? 
G_j,
" border="0"/>'s (for <img center src="http://latex.codecogs.com/gif.latex? 
j = 1, 2, \cdots, K
" border="0"/>). We further define <img center src="http://latex.codecogs.com/gif.latex? 
N_j
" border="0"/> as the number of points in <img center src="http://latex.codecogs.com/gif.latex? 
G_j,
" border="0"/> and <img center src="http://latex.codecogs.com/gif.latex? 
d(X_i, G_j
" border="0"/> as the (Euclidean) distance between data point (potentially multidimentional) <img center src="http://latex.codecogs.com/gif.latex? 
X_i
" border="0"/> and center of <img center src="http://latex.codecogs.com/gif.latex? 
G_j,
" border="0"/>.
<br> 
<br>
...
<div id="top">
    <a id="logo" href="<?php echo SITE_URL?>" target="_blank">
        <img src="{{ site.baseurl }}/images/k_means.jpg" alt="HTML5 Icon" style="width:500px;">
        <br>
        Figure 1: Main Steps of the K-means Algorithm
        <br>
        Adapted from Hartigan and Wong (1979)
    </a>
</div>
</center>
...
<div id="top">
    <a id="logo" href="<?php echo SITE_URL?>" target="_blank">
        ...
        <br>
        Figure 2: Main Steps of Stability Procedure
        <br>
